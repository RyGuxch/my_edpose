...
cls_no_bias = False
num_body_points = 21 # for coco
num_group = 100
num_box_decoder_layers = 2
no_mmpose_keypoint_evaluator = True

# ====== 核心：完全关闭数据增强，用这个 flag 控制 ======
no_aug = True  

# 下面这些就不再用于构建 RandomResize / RandomSizeCrop 了
# （留着也无所谓，反正 no_aug 时我们走另一条 transform 分支）
data_aug_scales = [800]
data_aug_max_size = 1333
data_aug_scales2_resize = [800]
data_aug_scales2_crop = [800]
data_aug_scale_overlap = 800
strong_aug = False